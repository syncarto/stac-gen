...
def create_stac_catalog(temp_dir, stac_config,progress_callback):
    ...
    try:
        ...
        collection = pystac.Collection(
                ...
                extent=collection_extent, # May throw error here, if extent isnt valid: https://github.com/stac-utils/pystac/blob/develop/pystac/collection.py#L117
    ...
    # spatial/temporal extents already have these values.
    # V>1.0 collection.extent['spatial'] = stac_config['COLLECTION_METADATA']['extent']['spatial']
    # V>1.0 collection.extent['temporal'] = stac_config['COLLECTION_METADATA']['extent']['temporal']
...
if __name__ == '__main__':
    ...
    ## Notes for upgrade to pyStac 1.0 (old code tagged with 'V<1.0')
